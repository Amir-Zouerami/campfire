...
function ActiveLeaveRow(props: {
	...
	const cancellationLocked = isApprovedLeaveCancellationLocked(request, props.timezone);
 ...
 */
function isApprovedLeaveCancellationLocked(request: LeaveRequest, timezone: string): boolean {
