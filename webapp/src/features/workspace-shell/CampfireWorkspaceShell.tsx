...
const workspacePages: readonly WorkspacePageDefinition[] = [
  ...
  },
  {
    ...
    title: "Settings",
    description:
      "Roles, calendar, standup forms, reminders, report rules, and audit history.",
    managerOnly: true,
  },
];
 ...
 */
export function CampfireWorkspaceShell(
      ...
      <div className="campfire-workspace-main">
        <header className="campfire-workspace-topline">
          <div className="campfire-workspace-topline-copy">
            <span className="campfire-workspace-topline-eyebrow">
              {activeDefinition.eyebrow}
            </span>
            <p className="campfire-workspace-topline-label">
  ...
  return (
    <aside className="campfire-app-sidebar">
      <div className="campfire-sidebar-brand">
        <div className="campfire-sidebar-logo-tile">
          <img
            src={campfireLogoURL}
            alt="Campfire"
            className="campfire-sidebar-logo-image"
          />
          <span
            className="campfire-logo-embers campfire-sidebar-logo-embers"
            aria-hidden="true"
          >
      ...
      <div className="campfire-sidebar-workspace">
        <span className="campfire-sidebar-workspace-name">
          {props.workspace.name}
        </span>
        <span className="campfire-sidebar-workspace-helper">
          Workspace · {props.workspace.timezone}
        </span>
      </div>

      <nav
        className="campfire-sidebar-nav"
        aria-label="Campfire workspace pages"
      >
        {props.pages.map((page) => {
          ...
          return (
            <button
              ...
              type="button"
              className={cn(
                "campfire-sidebar-nav-item",
                active && "campfire-sidebar-nav-item--active",
              )}
      ...
      <div className="campfire-sidebar-user">
        ...
        <span className="campfire-sidebar-user-copy">
          <span className="campfire-sidebar-user-name">
            {userDisplayName(
              props.currentUser.displayName,
              props.currentUser.username,
            )}
          </span>
          <span className="campfire-sidebar-user-role">
            {accessLabel(props)}
          </span>
        </span>
      </div>
...
function WorkspacePage(
  props: WorkspaceShellProps & { readonly activePage: WorkspacePageID },
): ReactElement {
