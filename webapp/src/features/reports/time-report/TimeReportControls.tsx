...
import type {
  TimeReportFilterDraft,
  TimeReportFilterPatch,
} from "./time-report.types";
 ...
 */
export function TimeReportControls(
  props: TimeReportControlsProps,
): ReactElement {
  /**
    ...
    <div className="campfire-control-grid campfire-control-grid--time-report">
      ...
      <CampfireField id="campfire-time-report-group" label="Group by">
        <CampfireSelect
          ...
          onValueChange={(value) =>
            props.onChange({ groupBy: toTimeReportGroupBy(value) })
          }
        >
