	...
	return (
		<div className="campfire-page-stack campfire-report-page-stack">
			...
			<CampfireReportSummaryBar
				items={[
					{ label: 'Saved filters', value: String(savedFilters.sortedFilters.length), tone: 'neutral' },
					{ label: 'Visible library', value: formatReportKind(savedFilters.selectedReportType), tone: 'neutral' },
					{ label: 'State', value: savedFilters.isBusy ? 'Working' : 'Ready', tone: savedFilters.isBusy ? 'warning' : 'success' },
				]}
			/>
