...
/**
 * ReportRuleBooleanFieldProps contains one boolean report-rule setting.
 */
type ReportRuleBooleanFieldProps = {
...
/**
 * ReportRuleBooleanField renders a consistently aligned checkbox setting.
 */
export function ReportRuleBooleanField(props: ReportRuleBooleanFieldProps): ReactElement {
	return (
