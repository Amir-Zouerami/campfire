...
export function StandupQuestionCard(props: StandupQuestionCardProps): ReactElement {
	...
	return (
		<article className="campfire-standup-question-editor">
			<div className="cf:flex cf:flex-wrap cf:items-start cf:justify-between cf:gap-3">
				<div className="cf:min-w-0">
					<p className="cf:text-xs cf:font-semibold cf:uppercase cf:tracking-[0.18em] cf:text-amber-100">
						{formatLabel(props.question.type)} · position {props.question.position}
					</p>
					<h4 className="cf:mt-1 cf:text-base cf:font-semibold cf:text-foreground">{props.question.label}</h4>
				...
				<div className="cf:flex cf:flex-wrap cf:gap-2">
					...
					{props.question.createsTasks && <CampfireStatusPill tone="ember">Tasks</CampfireStatusPill>}
			...
			<div className="cf:flex cf:justify-end">
				<Button type="button" disabled={formDisabled || !changed} onClick={() => void props.onSave(props.question)}>
