...
/**
 * TeamRuntimeFeedbackProps contains runtime feedback state.
 */
...
/**
 * TeamRuntimeFeedback renders runtime decision feedback and profile warnings.
 */
...
/**
 * TeamRuntimeLoading renders a compact runtime loading state.
 */
